...
export default function Hero1() {
    return (
        <div className="hero min-h-screen text-neutral-content overflow-y-visible relative">
            ...
            <div data-speed="0.5" className="absolute md:left-auto md:right-[1rem] top-10 min-w-2xl pointer-events-none">
                <Image src={mainImg} alt="main image" className='brightness-60 contrast-150 bg-transparent mask-gradient-bottom' priority />
            </div>
            {/* </div> */}
            <div className="hero-content min-h-screen justify-start lg:items-center items-end lg:w-[75vw] px-[3rem] text-neutral-content">
